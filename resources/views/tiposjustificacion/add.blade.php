...
@section('title', 'Agregar Tipo de Justificaci&oacute;n')
    ...
    {{--    @if (count($errors) > 0)
        ...
        <div class="ibox float-e-margins animated fadeInDown">
            ...
            <div class="ibox-content">
                <form class="form-horizontal" method="post" action="{{ URL::asset('tiposjustificacion/add') }}">
                    {!! csrf_field() !!}
                    ...
                    <div class="form-group{{ $errors->has('nombre') ? ' has-error' : '' }}"><label class="col-lg-2 control-label">Nombre</label>
                        ...
                        <div class="col-lg-10"><input type="text" name="nombre" placeholder="Ejemplo: Cita Medica" class="form-control" value="{{ old('nombre') }}">
