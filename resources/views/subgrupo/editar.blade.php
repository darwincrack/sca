    ...
    <div class="col-lg-12">
        ...
        <div class="ibox float-e-margins animated fadeInDown">
            ...
            <div class="ibox-content">
                <form class="form-horizontal" method="post" action="{{ URL::asset('subgrupo/editar') }}">
                    {!! csrf_field() !!}

                    <input name="id_sub_grupo" type="hidden" value="{{$id_sub_grupo}}">
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Grupo</label>
                        ...
                        <div class="col-sm-10">
                            ...
                            @foreach($data_grupo_personals as $data_grupo_personal)
                                    ...
                                    <option value="{{$data_grupo_personal->id}}"  {{($data_grupo_personal->id==$data_sub_grupos->id_grupo_personal)?"selected":""}}>
                    ...
                    <div class="form-group{{ $errors->has('nombre') ? ' has-error' : '' }}"><label class="col-lg-2 control-label">Nombre</label>
                        ...
                        <div class="col-lg-10"><input type="text" name="nombre" placeholder="Ejemplo: Profesores" class="form-control" value="{{$data_sub_grupos->nombre}}">
                    ...
                    <div class="form-group{{ $errors->has('descripcion') ? ' has-error' : '' }}"><label class="col-lg-2 control-label">Descripción</label>
                        ...
                        <div class="col-lg-10"><input type="text" name="descripcion" placeholder="Ejemplo: Grupo de profesores tarde" class="form-control" value="{{$data_sub_grupos->descripcion}}">
                        ...
                        <div class="col-lg-10">
                            <div class="switch">
                                <div class="onoffswitch">
                                    <input type="checkbox"    class="onoffswitch-checkbox" id="activo" name="activo" value="1" {{($data_sub_grupos->activo==1)?"checked=":'null'}}  >
